...
static int luagl_bitmap_raw( lua_State *L ) {
    ...
    glBitmap( (GLsizei)lua_tonumber( L, 1 ), (GLsizei)lua_tonumber( L, 2 ),
              (GLfloat)lua_tonumber( L, 3 ), (GLfloat)lua_tonumber( L, 4 ),
              (GLfloat)lua_tonumber( L, 5 ), (GLfloat)lua_tonumber( L, 6 ),
              lua_touserdata( L, 7 ) );
    return 0;
}
...
static int luagl_color( lua_State *L ) {
    ...
    switch ( num_args ) {
        case 3:
            glColor3d( (GLdouble)lua_tonumber( L, 1 ), (GLdouble)lua_tonumber( L, 2 ),
                       (GLdouble)lua_tonumber( L, 3 ) );
            break;
        case 4:
            glColor4d( (GLdouble)lua_tonumber( L, 1 ), (GLdouble)lua_tonumber( L, 2 ),
...
static int luagl_color_mask( lua_State *L ) {
    /* test arguments type */
    if ( !( lua_isboolean( L, 1 ) && lua_isboolean( L, 2 ) && lua_isboolean( L, 3 ) &&
            lua_isboolean( L, 4 ) ) )
...
static int luagl_copy_pixels( lua_State *L ) {
    ...
    /* test arguments type */
    if ( !( lua_isnumber( L, 1 ) && lua_isnumber( L, 2 ) && lua_isnumber( L, 3 ) &&
            lua_isnumber( L, 4 ) && lua_isstring( L, 5 ) ) )
...
static int luagl_copy_tex_sub_image( lua_State *L ) {
    ...
    if ( num_args >= 7 ) {
        glCopyTexSubImage2D( GL_TEXTURE_2D, (GLint)lua_tonumber( L, 1 ),
                             (GLint)lua_tonumber( L, 4 ), (GLint)lua_tonumber( L, 6 ),
                             (GLint)lua_tonumber( L, 2 ), (GLint)lua_tonumber( L, 3 ),
                             (GLint)lua_tonumber( L, 5 ), (GLint)lua_tonumber( L, 7 ) );
    } else {
        glCopyTexSubImage1D( GL_TEXTURE_1D, (GLint)lua_tonumber( L, 1 ),
                             (GLint)lua_tonumber( L, 4 ), (GLint)lua_tonumber( L, 2 ),
...
static int luagl_disable_client_state( lua_State *L ) {
    ...
    if ( e == LUAGL_ENUM_ERROR )
        LUAGL_SHOWERROR(
            "incorrect string argument to function 'gl.DisableClientState'" );
...
static int luagl_draw_pixels( lua_State *L ) {
    ...
    /* call opengl function */
    glDrawPixels( (GLsizei)lua_tonumber( L, 1 ), (GLsizei)lua_tonumber( L, 2 ), e,
                  GL_FLOAT, pixels );
...
static int luagl_draw_pixels_raw( lua_State *L ) {
    ...
    /* test arguments type */
    if ( !( lua_isnumber( L, 1 ) && lua_isnumber( L, 2 ) && lua_isstring( L, 3 ) &&
            lua_isstring( L, 4 ) && lua_isuserdata( L, 5 ) ) )
    ...
    /* call opengl function */
    glDrawPixels( (GLsizei)lua_tonumber( L, 1 ), (GLsizei)lua_tonumber( L, 2 ), format,
                  type, lua_touserdata( L, 5 ) );
...
static int luagl_eval_coord( lua_State *L ) {
    ...
    switch ( num_args ) {
        case 1:
            ...
            break;
        case 2:
            glEvalCoord2d( (GLdouble)lua_tonumber( L, 1 ),
...
static int luagl_get_tex_image_raw( lua_State *L ) {
    ...
    /* call opengl function */
    glGetTexImage( target, (GLuint)lua_tonumber( L, 2 ), format, type,
                   lua_touserdata( L, 5 ) );
...
static int luagl_line_stipple( lua_State *L ) {
    ...
    if ( lua_type( L, 2 ) == LUA_TSTRING )
        /* call opengl function */
        glLineStipple( (GLint)lua_tonumber( L, 1 ),
                       (GLushort)luagl_str2mask( lua_tostring( L, 2 ) ) );
...
static int luagl_map( lua_State *L ) {
    ...
    if ( lua_gettop( L ) < 6 ) {
        ...
        /* call opengl function */
        glMap1d( target, (GLdouble)lua_tonumber( L, 2 ), (GLdouble)lua_tonumber( L, 3 ),
                 size, uorder, points );
        ...
        /* call opengl function */
        glMap2d( target, (GLdouble)lua_tonumber( L, 2 ), (GLdouble)lua_tonumber( L, 3 ),
                 size, uorder, (GLdouble)lua_tonumber( L, 4 ),
...
static int luagl_raster_pos( lua_State *L ) {
    ...
    switch ( num_args ) {
        case 2:
            glRasterPos2d( (GLdouble)lua_tonumber( L, 1 ),
                           (GLdouble)lua_tonumber( L, 2 ) );
            break;
        case 3:
            glRasterPos3d( (GLdouble)lua_tonumber( L, 1 ), (GLdouble)lua_tonumber( L, 2 ),
                           (GLdouble)lua_tonumber( L, 3 ) );
            break;
        case 4:
            glRasterPos4d( (GLdouble)lua_tonumber( L, 1 ), (GLdouble)lua_tonumber( L, 2 ),
                           (GLdouble)lua_tonumber( L, 3 ),
...
static int luagl_read_pixels( lua_State *L ) {
    ...
    /* call opengl function */
    glReadPixels( (GLint)lua_tonumber( L, 1 ), (GLint)lua_tonumber( L, 2 ), width, height,
...
static int luagl_read_pixels_raw( lua_State *L ) {
    ...
    /* test arguments type */
    if ( !( lua_isnumber( L, 1 ) && lua_isnumber( L, 2 ) && lua_isnumber( L, 3 ) &&
            lua_isnumber( L, 4 ) && lua_isstring( L, 5 ) && lua_isstring( L, 6 ) &&
            lua_isuserdata( L, 7 ) ) )
    ...
    glReadPixels( (GLint)lua_tonumber( L, 1 ), (GLint)lua_tonumber( L, 2 ),
                  (GLsizei)lua_tonumber( L, 3 ), (GLsizei)lua_tonumber( L, 4 ), format,
...
static int luagl_stencil_func( lua_State *L ) {
    ...
    if ( lua_type( L, 3 ) == LUA_TSTRING )
        /* call opengl function */
        glStencilFunc( func, (GLint)lua_tonumber( L, 2 ),
                       luagl_str2mask( lua_tostring( L, 3 ) ) );
...
static int luagl_tex_image( lua_State *L ) {
    ...
    if ( ( height = luagl_get_array2ubyte( L, index, &pixels, &width ) ) != -1 ) {
        glTexImage2D( GL_TEXTURE_2D, (GLint)lua_tonumber( L, 1 ), iformat,
                      width / iformat, height, 0, e, GL_UNSIGNED_BYTE, pixels );
    } else {
        width = luagl_get_arrayubyte( L, index, &pixels );
        glTexImage1D( GL_TEXTURE_1D, (GLint)lua_tonumber( L, 1 ), iformat,
                      width / iformat, 0, e, GL_UNSIGNED_BYTE, pixels );
    }
    LUAGL_DELETE_ARRAY( pixels );
    return 0;
}
...
static int luagl_tex_image_2d( lua_State *L ) {
    ...
    if ( lua_isnumber( L, 1 ) && lua_isnumber( L, 2 ) && lua_isnumber( L, 3 ) &&
         ...
         lua_isstring( L, 7 ) && lua_isuserdata( L, 8 ) ) {
    ...
    glTexImage2D( GL_TEXTURE_2D, (GLint)lua_tonumber( L, 1 ),
                  (GLint)lua_tointeger( L, 2 ), (GLsizei)lua_tointeger( L, 3 ),
                  (GLsizei)lua_tointeger( L, 4 ), (GLint)lua_tointeger( L, 5 ), format,
                  type, lua_touserdata( L, 8 ) );
...
static int luagl_tex_sub_image( lua_State *L ) {
    ...
    if ( ( height = luagl_get_array2f( L, 3, &pixels, &width ) ) != -1 ) {
        glTexSubImage2D( GL_TEXTURE_2D, (GLint)lua_tonumber( L, 1 ),
                         (GLint)lua_tonumber( L, 4 ), (GLint)lua_tonumber( L, 5 ),
                         width / depth, height, format, GL_FLOAT, pixels );
    } else {
        width = luagl_get_arrayf( L, 3, &pixels );
        glTexSubImage1D( GL_TEXTURE_1D, (GLint)lua_tonumber( L, 1 ),
                         (GLint)lua_tonumber( L, 4 ), width / depth, format, GL_FLOAT,
                         pixels );
    }
    LUAGL_DELETE_ARRAY( pixels );
    return 0;
...
static int luagl_tex_sub_image_2d( lua_State *L ) {
    ...
    glTexSubImage2D( GL_TEXTURE_2D, (GLint)lua_tonumber( L, 1 ),
                     (GLint)lua_tonumber( L, 2 ), (GLint)lua_tonumber( L, 3 ),
                     (GLsizei)lua_tonumber( L, 4 ), (GLsizei)lua_tonumber( L, 5 ), format,
                     type, lua_touserdata( L, 8 ) );
...
static int luagl_tex_sub_image_1d( lua_State *L ) {
    ...
    glTexSubImage1D( GL_TEXTURE_1D, (GLint)lua_tonumber( L, 1 ),
                     (GLint)lua_tonumber( L, 2 ), (GLsizei)lua_tonumber( L, 3 ), format,
                     type, lua_touserdata( L, 6 ) );
...
static const struct luaL_Reg array_[] = { { "__index", array_index },
                                          { "new", array_new },
